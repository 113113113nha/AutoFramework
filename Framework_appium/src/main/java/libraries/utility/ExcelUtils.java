...
public class ExcelUtils {
    ...
    // 1.Open
    public static void open(String filename) throws IOException, InvalidFormatException {
    ...
    //---
    public static void openByPath(String path) throws IOException, InvalidFormatException {
        pathfile = path;
        file = new File(pathfile);
        ...
        if (file.exists() && file.canRead()) {
            ...
            try {
                ...
                System.out.println("Can not open file: " + file.getName());
            } finally {
                if (fIS != null) {
                    fIS.close();
                }
    ...
    public static Sheet getSheet(String SheetName) {
        if (!isSheet(SheetName)) {
            ...
            System.out.println("Sheet " + SheetName + " is ready");
        } else
    ...
    public static String getCellValue(int rowIndex, int colIndex) {
        return getCellValue(sheet.getSheetName(), rowIndex, colIndex + 1);
    }
    ...
    public static List<String> getColumnValues(String SheetName, int colIndex, int fromRow) {
        ...
        try {
            ...
            System.out.println("SheetName, ColIndex or FromRowIndex is unavailable");
        }
        return cellValues;
    }
    ...
    public static List<String> getRowValue(String SheetName, int rowIndex, int fromCol) {
        ...
        try {
            ...
            System.out.println("SheetName, Row or Col is unavailable");
        }
        return cellValues;
    }
...
//        cellStyle.setRotation((short) 120);
//        cellStyle.setWrapText(true);
    ...
    public static void setRowHeight(int rowIndex, int size) {
        try {
            ...
            System.out.println("Row is unavailable");
        }
    }
    ...
    public static int getColNumberAnyRow(String SheetName, int rowIndex) {
        ...
        try {
            ...
            System.out.println("Do not exist Row: " + rowIndex);
            return -1;
        }
    }
